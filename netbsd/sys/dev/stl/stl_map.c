...
{
    struct map_pair *maps = malloc(sizeof(*maps), M_DEVBUF, M_WAITOK);
...
{
    struct entry *e = malloc(sizeof(*e) + len, M_DEVBUF, M_WAITOK);
    memset(e, 0, sizeof(*e) + len);
    return e+1;
}
